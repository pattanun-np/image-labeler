...
export default class extends PureComponent {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.lazyRadius !== this.props.lazyRadius) {
            ...
            this
                .lazy
                .setRadius(this.props.lazyRadius * window.devicePixelRatio);
        }
    ...
    handlePointerMove = (x, y) => {
        ...
        if (this.isDrawing && (this.lazy.brushHasMoved() || isDisabled)) {
            ...
            // Draw current points
            this.drawPoints({points: this.points, brushColor: this.props.brushColor, brushRadius: this.props.brushRadius});
        }
    ...
    drawPoints = ({points, brushColor, brushRadius}) => {
        ...
        // Draw last line as a straight line while we wait for the next point to be able
        // to calculate the bezier control point
        this
            .ctx
            .temp
            .lineTo(p1.x, p1.y);
    ...
    saveLine = ({brushColor, brushRadius} = {}) => {
        ...
        this
            .ctx
            .drawing
            .drawImage(this.canvas.temp, 0, 0, width, height);
    ...
    clear = () => {
        ...
        this
            .ctx
            .drawing
            .clearRect(0, 0, this.canvas.drawing.width, this.canvas.drawing.height);
        this
            .ctx
            .temp
            .clearRect(0, 0, this.canvas.temp.width, this.canvas.temp.height);
    };
    ...
    drawInterface = (ctx, pointer, brush) => {
        ...
        if (this.lazy.isEnabled()) {
            ...
            this
                .catenary
                .drawToCanvas(this.ctx.interface, brush, pointer, this.chainLength);
            ctx.stroke();
        }
            ...
            <div
                ...
                {canvasTypes.map(({name, zIndex}) => {
                    ...
                    return (<canvas
                        ...
                        onMouseDown={isInterface
                        ? this.handleMouseDown
                        : undefined}
                        onMouseMove={isInterface
                        ? this.handleMouseMove
                        : undefined}
                        onMouseUp={isInterface
                        ? this.handleMouseUp
                        : undefined}
                        onMouseOut={isInterface
                        ? this.handleMouseUp
                        : undefined}
                        onTouchStart={isInterface
                        ? this.handleTouchStart
                        : undefined}
                        onTouchMove={isInterface
                        ? this.handleTouchMove
                        : undefined}
                        onTouchEnd={isInterface
                        ? this.handleTouchEnd
                        : undefined}
                        onTouchCancel={isInterface
                        ? this.handleTouchEnd
                        : undefined}/>);
                })}
            </div>
