...
class Login extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            li className = {
                this.state.register === 'Tabs1' && 'is-active'
            }
            onClick = {
                () => {
                    this.setState({
            ...
            <
            a className = "Tabs" > < Image is = "16x16 "
            src = " https://image.flaticon.com/icons/svg/40/40358.svg" / >
            <
            span >
            SignUp <
            /span> <
            ...
            /li> <
            li className = {
                this.state.register === 'Tabs2' && 'is-active'
            }
            onClick = {
                () => {
                    this.setState({
            ...
            /Tabs> {
                ...
                onChange = {
                    ...
                    <
                    h1 className = {
                        this.state.position === 'Select your role' && 'Error'
                    } > Selected: {
                        this.state.position
                    }
